...
- (void)postByteData:(NSData *)byteData {
    ...
    NSString *urlString = [NSString stringWithFormat:@"https://www.google.com/speech-api/v2/recognize?xjerr=1&maxresults=10&pFilter=0&output=json&&client=chromium&lang=%@&key=%@", GOOGLE_SPEECH_TO_TEXT_LANG,GOOGLE_SPEECH_TO_TEXT_KEY];
    ...
    [NSURLConnection sendAsynchronousRequest:request
                           ...
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
                               ...
                               if (translates) {
                                   SAFE_PERFORM_SELECTOR_WITH_OBJECT(self.delegate, @selector(didReceiveVoiceResponse:), translates);
                               } else {
